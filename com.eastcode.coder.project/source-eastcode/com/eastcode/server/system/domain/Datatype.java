...
@Entity
@Table(name = "DATATYPE")
public class Datatype implements PersistentObject {
	...
	private Set<Basedata> basedatas = new HashSet<Basedata>(0);
	...
	@OneToMany
	@Transient
	public Set<Basedata> getBasedatas() {
		return this.basedatas;
	}

	public void setBasedatas(Set<Basedata> basedatas) {
